    ...
    with get_conn() as conn:
        for row in INGREDIENTS:
            conn.execute(
                ...
                "supplier_name,supplier_pack_label,pack_size,pack_cost) "
                "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                row,
            )
        for row in PRODUCTS:
